...
/*
 * SlimePower extends the abstract class PowerUp.
 * 
 * This class marks that a specific gorilla has the Slime power up.
 * 
 * By: Helene
 */
public class SlimePower extends PowerUp {
	 ...
	 * collected()
	 * 
	 * If the player has no power up, its hasPow is changed to "slime" and collected() in PowerUp is called.
	 */
