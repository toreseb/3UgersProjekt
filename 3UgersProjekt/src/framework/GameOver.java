...
public class GameOver {
	...
	private static Group createContent() {
		...
		else background.setFitHeight(HEIGHT);
		...
		playAgain.setStyle("-fx-background-color: linear-gradient(to right bottom, #31CCB0, #2C90C4); -fx-background-radius: 25px;");
		...
		exit.setBorder(null);
		exit.setStyle("-fx-background-color: linear-gradient(to right bottom, #B22858, #E36138); -fx-background-radius: 25px;");
